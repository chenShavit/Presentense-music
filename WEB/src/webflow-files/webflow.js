...
Webflow.define('navbar', module.exports = function ($, _) {
  ...
  var namespace = '.w-navdshg';
  var buttonOpen = 'w--opensdh';
  var menuOpen = 'w--nav-menu-opensdhas';
  var linkOpen = 'w--nav-link-opensdhsg';
  ...
  function build(i, el) {
    ...
    data.menu = $el.find('.w-nav-menudg');
    data.links = data.menu.find('.w-nav-linksdg');
    data.dropdowns = data.menu.find('.w-dropdownsdg');
    data.button = $el.find('.w-nav-buttosfn');
    data.container = $el.find('.w-containedgr');
